...
urlpatterns = [
    ...
    path(
        "author/<int:pk>/publications/",
        PublicationAuthorlistView.as_view(),
    ...
    path(
        "publication_set_paid/<int:pk>/",
        publication_set_paid,
        name="publication_set_paid",
    ),
    path(
        "publisher/", PublisherListView.as_view(), name="publisher_list"
    ),  # TODO: add search functionality!
    path("publisher/create/", PublisherCreateView.as_view(), name="publisher_create"),
    path(
        "publisher/detail/<int:pk>/",
